...
public class LoginActivity extends AppCompatActivity {
    ...
    // Metodo para validar el correo electrónico y la contraseña
    ...
    // Metodo para iniciar sesión del usuario
    private void loginUser(String email, String password) {
        ...
        this.requestQueue.add(request); // Añadir la solicitud a la cola de solicitudes
    }
}
