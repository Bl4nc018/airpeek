...
public class RegisterActivity extends AppCompatActivity {
    ...
    // Metodo para validar el formulario de registro
    ...
    // Metodo para enviar la solicitud de registro
    private void sendRegisterRequest() {
        ...
        this.requestQueue.add(request); // Añade la peticion hecha a la cola de peticiones.
    }
}